...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION reference.get_language_by_iso6391(p_iso6391 CHAR(2)) RETURNS reference.language AS $$
DECLARE
	v_language reference.language%ROWTYPE;
BEGIN
	SELECT * INTO v_language
	FROM reference.language
	WHERE ISO_639_1_Code = p_iso6391;
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION reference.get_language_by_iso6392(p_iso6392 CHAR(3)) RETURNS reference.language AS $$
DECLARE
	v_language reference.language%ROWTYPE;
BEGIN
	SELECT * INTO v_language
	FROM reference.language
	WHERE ISO_639_2_Code_b = p_iso6392 OR ISO_639_2_Code_t = p_iso6392;
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION reference.get_language_by_english_name(p_english_name VARCHAR) RETURNS reference.language AS $$
DECLARE
	v_language reference.language%ROWTYPE;
BEGIN
	SELECT * INTO v_language
	FROM reference.language
	WHERE english_name = p_english_name;
	RETURN v_language;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION reference.get_language_by_french_name(p_french_name VARCHAR) RETURNS reference.language AS $$
DECLARE
	v_language reference.language%ROWTYPE;
BEGIN
	SELECT * INTO v_language
	FROM reference.language
	WHERE french_name = p_french_name;
	RETURN v_language;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION reference.get_language_by_id(p_id BIGINT) RETURNS reference.language AS $$
DECLARE
	v_language reference.language%ROWTYPE;
BEGIN
	SELECT * INTO v_language
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION reference.get_all_languages() RETURNS SETOF reference.language AS $$
BEGIN
	RETURN QUERY SELECT * FROM reference.language;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION reference.insert_language(
	p_iso6392_b CHAR(3),
	p_iso6392_t CHAR(3),
	p_iso6391 CHAR(2),
	p_english_name VARCHAR,
	p_french_name VARCHAR,
...
DECLARE
	v_id BIGINT;
BEGIN
	INSERT INTO reference.language(
		ISO_639_2_Code_b, ISO_639_2_Code_t, ISO_639_1_Code, english_name, french_name,
		created_at, updated_at, updated_by
	) VALUES (
		p_iso6392_b, p_iso6392_t, p_iso6391, p_english_name, p_french_name,
		now(), now(), p_updated_by
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION reference.update_language(
	p_id BIGINT,
	p_iso6392_b CHAR(3),
	p_iso6392_t CHAR(3),
	p_iso6391 CHAR(2),
...
BEGIN
	UPDATE reference.language SET
		ISO_639_2_Code_b = p_iso6392_b,
		ISO_639_2_Code_t = p_iso6392_t,
		ISO_639_1_Code = p_iso6391,
		english_name = p_english_name,
		french_name = p_french_name,
		updated_at = now(),
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION reference.delete_language(p_id BIGINT) RETURNS VOID AS $$
BEGIN
	DELETE FROM reference.language WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
create or replace function reference.insert_city(p_name VARCHAR, p_latitude FLOAT, p_longitude FLOAT, p_country_id BIGINT, p_zone VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE
	v_id BIGINT;
BEGIN
	INSERT INTO reference.city(name, latitude, longitude, country_id, zone, updated_by)
	VALUES (p_name, p_latitude, p_longitude, p_country_id, p_zone, p_updated_by)
	RETURNING id INTO v_id;
	RETURN v_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
create or replace function reference.update_city(p_id BIGINT, p_name VARCHAR, p_latitude FLOAT, p_longitude FLOAT, p_country_id BIGINT, p_zone VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
	UPDATE reference.city SET
	name = p_name,
	latitude = p_latitude,
...
-- 
-- =========================================================
create or replace function reference.delete_city(p_id BIGINT) RETURNS VOID AS $$
BEGIN
	DELETE FROM reference.city WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION reference.get_city_by_id(p_id BIGINT) RETURNS reference.city AS $$
DECLARE
    v_city reference.city%ROWTYPE;
BEGIN
    SELECT * INTO v_city
    FROM reference.city
    WHERE id = p_id;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION reference.get_city_by_name(p_name VARCHAR) RETURNS reference.city AS $$
DECLARE
    v_city reference.city%ROWTYPE;
BEGIN
    SELECT * INTO v_city
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION reference.get_all_cities() RETURNS SETOF reference.city AS $$
BEGIN
    RETURN QUERY SELECT * FROM reference.city;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION reference.get_cities_by_country_id(p_country_id BIGINT) RETURNS SETOF reference.city AS $$
BEGIN
    RETURN QUERY SELECT * FROM reference.city WHERE country_id = p_country_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION reference.get_cities_by_zone(p_zone VARCHAR) RETURNS SETOF reference.city AS $$
BEGIN
    RETURN QUERY SELECT * FROM reference.city WHERE zone = p_zone;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION network.get_zone_by_code(p_code VARCHAR) RETURNS network.zone AS $$
DECLARE
	v_zone network.zone%ROWTYPE;
BEGIN
	SELECT * INTO v_zone
	FROM network.zone
	WHERE code = p_code;
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION network.get_zone_by_name(p_name VARCHAR) RETURNS network.zone AS $$
DECLARE
	v_zone network.zone%ROWTYPE;
BEGIN
	SELECT * INTO v_zone
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION network.get_zone_by_id(p_id BIGINT) RETURNS network.zone AS $$
DECLARE
	v_zone network.zone%ROWTYPE;
BEGIN
	SELECT * INTO v_zone
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION network.get_all_zones() RETURNS SETOF network.zone AS $$
BEGIN
	RETURN QUERY SELECT * FROM network.zone;
END;
$$ LANGUAGE plpgsql;
...
DECLARE
	v_id BIGINT;
BEGIN
	INSERT INTO network.zone(code, name, created_at, updated_at, updated_by)
	VALUES (p_code, p_name, now(), now(), p_updated_by)
	RETURNING id INTO v_id;
	RETURN v_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION network.update_zone(p_id BIGINT, p_code VARCHAR, p_name VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
	UPDATE network.zone SET
	code = p_code,
	name = p_name,
	updated_at = now(),
	updated_by = p_updated_by
...
-- 
-- =========================================================
CREATE  OR REPLACE FUNCTION network.delete_zone(p_id BIGINT) RETURNS VOID AS $$
BEGIN
	DELETE FROM network.zone WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
create or replace function network.get_stop_by_code(p_code VARCHAR) RETURNS network.stop AS $$
DECLARE
	v_stop network.stop%ROWTYPE;
BEGIN
	SELECT * INTO v_stop
	FROM network.stop
	WHERE code = p_code;
...
create  or replace function network.get_stop_by_name(p_name VARCHAR) RETURNS network.stop AS $$
DECLARE
	v_stop network.stop%ROWTYPE;
BEGIN
	SELECT * INTO v_stop
...
-- 
-- =========================================================
create or replace function network.get_stop_by_id(p_id BIGINT) RETURNS network.stop AS $$
DECLARE
	v_stop network.stop%ROWTYPE;
BEGIN
	SELECT * INTO v_stop
...
-- 
-- =========================================================
create or replace function network.get_all_stops() RETURNS SETOF network.stop AS $$
BEGIN
	RETURN QUERY SELECT * FROM network.stop;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
create or replace function network.update_stop(p_id BIGINT, p_code VARCHAR, p_name VARCHAR, p_type common.STOP_TYPE, p_zone_id BIGINT, p_post_code VARCHAR, p_geo common.geography, p_additional_info VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
	UPDATE network.stop SET
	code = p_code,
	name = p_name,
	type = p_type,
	zone_id = p_zone_id,
...
-- 
-- =========================================================
create or replace function network.delete_stop(p_id BIGINT) RETURNS VOID AS $$
BEGIN
	DELETE FROM network.stop WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
create or replace function network.get_stop_point_by_id(p_id BIGINT) RETURNS network.stop_point AS $$
DECLARE
	v_stop_point network.stop_point%ROWTYPE;
BEGIN
	SELECT * INTO v_stop_point
	FROM network.stop_point
	WHERE id = p_id;
	RETURN v_stop_point;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
create or replace function network.insert_stop_point(p_platform VARCHAR, p_direction VARCHAR, p_additional_info VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE
	v_id BIGINT;
BEGIN
	INSERT INTO network.stop_point(platform, direction, additional_info, created_at, updated_at, updated_by)
	VALUES (p_platform, p_direction, p_additional_info, now(), now(), p_updated_by)
	RETURNING id INTO v_id;
	RETURN v_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
create or replace function network.update_stop_point(p_id BIGINT, p_platform VARCHAR, p_direction VARCHAR, p_additional_info VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
	UPDATE network.stop_point SET
	platform = p_platform,
...
-- 
-- =========================================================
create or replace function network.delete_stop_point(p_id BIGINT) RETURNS VOID AS $$
BEGIN
	DELETE FROM network.stop_point WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_facility_by_code(p_code VARCHAR) RETURNS network.facility AS $$
DECLARE
	v_facility network.facility%ROWTYPE;
BEGIN
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_facility_by_name(p_name VARCHAR) RETURNS network.facility AS $$
DECLARE
	v_facility network.facility%ROWTYPE;
BEGIN
	SELECT * INTO v_facility
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_facility_by_id(p_id BIGINT) RETURNS network.facility AS $$
DECLARE
    v_facility network.facility%ROWTYPE;
BEGIN
    SELECT * INTO v_facility
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_all_facilities() RETURNS SETOF network.facility AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.facility;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.insert_facility(p_code VARCHAR, p_name VARCHAR, p_additional_info VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE
    v_id BIGINT;
BEGIN
    INSERT INTO network.facility(code, name, additional_info, created_at, updated_at, updated_by)
    VALUES (p_code, p_name, p_additional_info, now(), now(), p_updated_by)
    RETURNING id INTO v_id;
    RETURN v_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.update_facility(p_id BIGINT, p_code VARCHAR, p_name VARCHAR, p_additional_info VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE network.facility SET
        code = p_code,
        name = p_name,
        additional_info = p_additional_info,
        updated_at = now(),
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_facility(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.facility WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_facility_by_code(p_code VARCHAR) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.facility WHERE code = p_code;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_facility_by_name(p_name VARCHAR) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.facility WHERE name = p_name;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_facility_by_id(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.facility WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
create or replace function network.insert_stop_facility(p_stop_id BIGINT, p_stop_facility_id BIGINT, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE
    v_id BIGINT;
BEGIN
    INSERT INTO network.stop_facilities(stop_id, stop_facility_id, created_at, updated_at, updated_by)
    VALUES (p_stop_id, p_stop_facility_id, now(), now(), p_updated_by)
    RETURNING id INTO v_id;
    RETURN v_id;
END;
$$ LANGUAGE plpgsql;

create or replace function network.delete_stop_facility(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.stop_facilities WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_stop_facilities_by_stop_id(p_stop_id BIGINT) RETURNS SETOF network.stop_facilities AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.stop_facilities WHERE stop_id = p_stop_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_stop_facilities_by_facility_id(p_stop_facility_id BIGINT) RETURNS SETOF network.stop_facilities AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.stop_facilities WHERE stop_facility_id = p_stop_facility_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_stop_facility_by_id(p_id BIGINT) RETURNS network.stop_facilities AS $$
DECLARE
    v_stop_facility network.stop_facilities%ROWTYPE;
BEGIN
    SELECT * INTO v_stop_facility
    FROM network.stop_facilities
    WHERE id = p_id;
    RETURN v_stop_facility;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_all_stop_facilities() RETURNS SETOF network.stop_facilities AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.stop_facilities;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_facility_by_stop_id(p_stop_id BIGINT) RETURNS SETOF network.facility AS $$
BEGIN
    RETURN QUERY SELECT f.*
    FROM network.stop_facilities sf
    JOIN network.facility f ON sf.stop_facility_id = f.id
    WHERE sf.stop_id = p_stop_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_stops_by_facility_id(p_stop_facility_id BIGINT) RETURNS SETOF network.stop AS $$
BEGIN
    RETURN QUERY SELECT s.*
    FROM network.stop_facilities sf
    JOIN network.stop s ON sf.stop_id = s.id
    WHERE sf.stop_facility_id = p_stop_facility_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_stop_facility_by_stop_id_and_facility_id(p_stop_id BIGINT, p_stop_facility_id BIGINT) RETURNS network.stop_facilities AS $$
DECLARE
    v_stop_facility network.stop_facilities%ROWTYPE;
BEGIN
    SELECT * INTO v_stop_facility
    FROM network.stop_facilities
    WHERE stop_id = p_stop_id AND stop_facility_id = p_stop_facility_id;
    RETURN v_stop_facility;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_stop_facility_by_stop_id_and_facility_id(p_stop_id BIGINT, p_stop_facility_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.stop_facilities
    WHERE stop_id = p_stop_id AND stop_facility_id = p_stop_facility_id;
END;
$$ LANGUAGE plpgsql;

CreaTE OR REPLACE FUNCTION network.update_stop_facility(p_id BIGINT, p_stop_id BIGINT, p_stop_facility_id BIGINT, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE network.stop_facilities SET
    stop_id = p_stop_id,
    stop_facility_id = p_stop_facility_id,
    updated_at = now(),
    updated_by = p_updated_by
    WHERE id = p_id;
END;
...
create or replace function network.update_stop_facility_by_stop_id_and_facility_id(p_stop_id BIGINT, p_stop_facility_id BIGINT, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE network.stop_facilities SET
    updated_at = now(),
    updated_by = p_updated_by
...
create or replace function network.delete_stop_facility_by_stop_id(p_stop_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.stop_facilities
...
create or replace function network.delete_stop_facility_by_facility_id(p_stop_facility_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.stop_facilities
    WHERE stop_facility_id = p_stop_facility_id;
END;
$$ LANGUAGE plpgsql;

create or replace function network.delete_stop_facility_by_id(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.stop_facilities
    WHERE id = p_id;
END;
...
-- 
-- =========================================================
create or replace function network.get_operator_by_code(p_code VARCHAR) RETURNS network.operator AS $$
DECLARE
    v_operator network.operator%ROWTYPE;
BEGIN
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_operator_by_name(p_name VARCHAR) RETURNS network.operator AS $$
DECLARE
    v_operator network.operator%ROWTYPE;
BEGIN
    SELECT * INTO v_operator
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_operator_by_id(p_id BIGINT) RETURNS network.operator AS $$
DECLARE
    v_operator network.operator%ROWTYPE;
BEGIN
    SELECT * INTO v_operator
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_all_operators() RETURNS SETOF network.operator AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.operator;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.insert_operator(p_code VARCHAR, p_name VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE
    v_id BIGINT;
BEGIN
    INSERT INTO network.operator(code, name, created_at, updated_at, updated_by)
    VALUES (p_code, p_name, now(), now(), p_updated_by)
    RETURNING id INTO v_id;
    RETURN v_id;
END;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.update_operator(p_id BIGINT, p_code VARCHAR, p_name VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE network.operator SET
    code = p_code,
    name = p_name,
    updated_at = now(),
    updated_by = p_updated_by
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_operator(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.operator WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_network_by_code(p_code VARCHAR) RETURNS network.network AS $$
DECLARE
    v_network network.network%ROWTYPE;
BEGIN
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_network_by_name(p_name VARCHAR) RETURNS network.network AS $$
DECLARE
    v_network network.network%ROWTYPE;
BEGIN
    SELECT * INTO v_network
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_network_by_id(p_id BIGINT) RETURNS network.network AS $$
DECLARE
    v_network network.network%ROWTYPE;
BEGIN
    SELECT * INTO v_network
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_all_networks() RETURNS SETOF network.network AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.network;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.insert_network(p_code VARCHAR, p_name VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$

DECLARE
    v_id BIGINT;
BEGIN
    INSERT INTO network.network(code, name, created_at, updated_at, updated_by)
    VALUES (p_code, p_name, now(), now(), p_updated_by)
    RETURNING id INTO v_id;
    RETURN v_id;
END;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.update_network(p_id BIGINT, p_code VARCHAR, p_name VARCHAR, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE network.network SET
    code = p_code,
    name = p_name,
    updated_at = now(),
    updated_by = p_updated_by
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_network(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.network WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_operator_network_by_operator_id_and_network_id(p_operator_id BIGINT, p_network_id BIGINT) RETURNS network.operator_network AS $$
DECLARE
    v_operator_network network.operator_network%ROWTYPE;
BEGIN
    SELECT * INTO v_operator_network
    FROM network.operator_network
    WHERE operator_id = p_operator_id AND network_id = p_network_id;
    RETURN v_operator_network;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_operator_network_by_id(p_id BIGINT) RETURNS network.operator_network AS $$
DECLARE    v_operator_network network.operator_network%ROWTYPE;
BEGIN
    SELECT * INTO v_operator_network
    FROM network.operator_network
    WHERE id = p_id;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_operator_network_by_operator_id(p_operator_id BIGINT) RETURNS SETOF network.operator_network AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.operator_network WHERE operator_id = p_operator_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_operator_network_by_network_id(p_network_id BIGINT) RETURNS SETOF network.operator_network AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.operator_network WHERE network_id = p_network_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.insert_operator_network(p_operator_id BIGINT, p_network_id BIGINT, p_trans_mode common.TRANSPORT_MODE, p_country_id BIGINT, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE
    v_id BIGINT;
BEGIN
    INSERT INTO network.operator_network(operator_id, network_id, trans_mode, country_id, created_at, updated_at, updated_by)
    VALUES (p_operator_id, p_network_id, p_trans_mode, p_country_id, now(), now(), p_updated_by)
    RETURNING id INTO v_id;
    RETURN v_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.update_operator_network(p_id BIGINT, p_operator_id BIGINT, p_network_id BIGINT, p_trans_mode common.TRANSPORT_MODE, p_country_id BIGINT, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE network.operator_network SET
    operator_id = p_operator_id,
    network_id = p_network_id,
    trans_mode = p_trans_mode,
    country_id = p_country_id,
    updated_at = now(),
    updated_by = p_updated_by
    WHERE id = p_id;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_operator_network(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.operator_network WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_operator_network_by_operator_id(p_operator_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.operator_network WHERE operator_id = p_operator_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_operator_network_by_network_id(p_network_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.operator_network WHERE network_id = p_network_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_operator_network_by_operator_id_and_network_id(p_operator_id BIGINT, p_network_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.operator_network WHERE operator_id = p_operator_id AND network_id = p_network_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_operator_network_by_id(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.operator_network WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_all_operator_networks() RETURNS SETOF network.operator_network AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.operator_network;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_networks_by_operator_id(p_operator_id BIGINT) RETURNS SETOF network.network AS $$
BEGIN
    RETURN QUERY SELECT n.*
    FROM network.operator_network onw
    JOIN network.network n ON onw.network_id = n.id
    WHERE onw.operator_id = p_operator_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_operators_by_network_id(p_network_id BIGINT) RETURNS SETOF network.operator AS $$
BEGIN
    RETURN QUERY SELECT o.*
    FROM network.operator_network onw
    JOIN network.operator o ON onw.operator_id = o.id
    WHERE onw.network_id = p_network_id;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    SELECT * INTO v_operator_network
    FROM network.operator_network    WHERE operator_id = p_operator_id AND network_id = p_network_id;
    RETURN v_operator_network;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_line_by_public_code(p_public_code VARCHAR) RETURNS network.line AS $$
DECLARE
    v_line network.line%ROWTYPE;
BEGIN
    SELECT * INTO v_line
    FROM network.line    WHERE public_code = p_public_code;
    RETURN v_line;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_line_by_id(p_id BIGINT) RETURNS network.line AS $$
DECLARE    v_line network.line%ROWTYPE;
BEGIN
    SELECT * INTO v_line
    FROM network.line    WHERE id = p_id;
    RETURN v_line;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_lines_by_operator_id(p_operator_id BIGINT) RETURNS SETOF network.line AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.line WHERE operator_id = p_operator_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.insert_line(p_name VARCHAR, p_public_code VARCHAR, p_trans_mode common.TRANSPORT_MODE, p_operator_id BIGINT, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE    v_id BIGINT;
BEGIN
    INSERT INTO network.line(name, public_code, trans_mode, operator_id, created_at, updated_at, updated_by)
    VALUES (p_name, p_public_code, p_trans_mode, p_operator_id, now(), now(), p_updated_by)
    RETURNING id INTO v_id;
    RETURN v_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.update_line(p_id BIGINT, p_name VARCHAR, p_public_code VARCHAR, p_trans_mode common.TRANSPORT_MODE, p_operator_id BIGINT, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE network.line SET
    name = p_name,
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_line(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.line WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_by_code(p_code VARCHAR) RETURNS network.service AS $$
DECLARE
    v_service network.service%ROWTYPE;
BEGIN
    SELECT * INTO v_service
    FROM network.service    WHERE code = p_code;
    RETURN v_service;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_by_id(p_id BIGINT) RETURNS network.service AS $$
DECLARE    v_service network.service%ROWTYPE;
BEGIN
    SELECT * INTO v_service
    FROM network.service    WHERE id = p_id;
    RETURN v_service;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_services_by_line_id(p_line_id BIGINT) RETURNS SETOF network.service AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.service WHERE line_id = p_line_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.insert_service(p_line_id BIGINT, p_code VARCHAR, p_compass_direction common.COMPASS_DIRECTION, p_from_stop_id BIGINT, p_to_stop_id BIGINT, p_distance_meters INTEGER, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE    v_id BIGINT;
BEGIN
    INSERT INTO network.service(line_id, code, compass_direction, from_stop_id, to_stop_id, distance_meters, created_at, updated_at, updated_by)
    VALUES (p_line_id, p_code, p_compass_direction, p_from_stop_id, p_to_stop_id, p_distance_meters, now(), now(), p_updated_by)
    RETURNING id INTO v_id;
    RETURN v_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.update_service(p_id BIGINT, p_line_id BIGINT, p_code VARCHAR, p_compass_direction common.COMPASS_DIRECTION, p_from_stop_id BIGINT, p_to_stop_id BIGINT, p_distance_meters INTEGER, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE network.service SET
    line_id = p_line_id,
    code = p_code,
    compass_direction = p_compass_direction,
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_service(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.service WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_link_by_id(p_id BIGINT) RETURNS network.service_link AS $$
DECLARE    v_service_link network.service_link%ROWTYPE;
BEGIN
    SELECT * INTO v_service_link
    FROM network.service_link    WHERE id = p_id;
    RETURN v_service_link;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_links_by_service_id(p_service_id BIGINT) RETURNS SETOF network.service_link AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.service_link WHERE service_id = p_service_id ORDER BY sequence_order;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.insert_service_link(p_service_id BIGINT, p_from_stop_id BIGINT, p_to_stop_id BIGINT, p_distance_meters INTEGER, p_sequence_order INTEGER, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE    v_id BIGINT;
BEGIN
    INSERT INTO network.service_link(service_id, from_stop_id, to_stop_id, distance_meters, sequence_order, created_at, updated_at, updated_by)
    VALUES (p_service_id, p_from_stop_id, p_to_stop_id, p_distance_meters, p_sequence_order, now(), now(), p_updated_by)
    RETURNING id INTO v_id;
    RETURN v_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.update_service_link(p_id BIGINT, p_service_id BIGINT, p_from_stop_id BIGINT, p_to_stop_id BIGINT, p_distance_meters INTEGER, p_sequence_order INTEGER, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE network.service_link SET
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_service_link(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.service_link WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instance_by_id(p_id BIGINT) RETURNS network.service_instance AS $$
DECLARE    v_service_instance network.service_instance%ROWTYPE;
BEGIN
    SELECT * INTO v_service_instance
    FROM network.service_instance    WHERE id = p_id;
    RETURN v_service_instance;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_service_id(p_service_id BIGINT) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.service_instance WHERE service_id = p_service_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.insert_service_instance(p_service_id BIGINT, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE    v_id BIGINT;
BEGIN
    INSERT INTO network.service_instance(service_id, created_at, updated_at, updated_by)
    VALUES (p_service_id, now(), now(), p_updated_by)
    RETURNING id INTO v_id;
    RETURN v_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_service_instance(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.service_instance WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_service_instances_by_service_id(p_service_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.service_instance WHERE service_id = p_service_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_date_range(p_service_id BIGINT, p_start_time TIMESTAMP, p_end_time TIMESTAMP) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND sli.departure_time >= p_start_time
    AND sli.departure_time <= p_end_time
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_date(p_service_id BIGINT, p_date DATE) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND DATE(sli.departure_time) = p_date
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_departure_time_range(p_service_id BIGINT, p_start_time TIMESTAMP, p_end_time TIMESTAMP) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_arrival_time_range(p_service_id BIGINT, p_start_time TIMESTAMP, p_end_time TIMESTAMP) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND sli.arrival_time >= p_start_time
    AND sli.arrival_time <= p_end_time
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_departure_date_range(p_service_id BIGINT, p_start_date DATE, p_end_date DATE) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND DATE(sli.departure_time) >= p_start_date
    AND DATE(sli.departure_time) <= p_end_date
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_arrival_date_range(p_service_id BIGINT, p_start_date DATE, p_end_date DATE) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND DATE(sli.arrival_time) >= p_start_date
    AND DATE(sli.arrival_time) <= p_end_date
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_departure_time(p_service_id BIGINT, p_departure_time TIMESTAMP) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND sli.departure_time = p_departure_time
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_arrival_time(p_service_id BIGINT, p_arrival_time TIMESTAMP) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND sli.arrival_time = p_arrival_time
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_departure_date(p_service_id BIGINT, p_departure_date DATE) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND DATE(sli.departure_time) = p_departure_date
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_arrival_date(p_service_id BIGINT, p_arrival_date DATE) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND DATE(sli.arrival_time) = p_arrival_date
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- -- 
-- -- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_date_and_time_range(p_service_id BIGINT, p_date DATE, p_start_time TIME, p_end_time TIME) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND DATE(sli.departure_time) = p_date
    AND sli.departure_time::time >= p_start_time
    AND sli.departure_time::time <= p_end_time
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_date_and_time(p_service_id BIGINT, p_date DATE, p_time TIME) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND DATE(sli.departure_time) = p_date
    AND sli.departure_time::time = p_time
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE si.service_id = p_service_id
    AND DATE(sli.arrival_time) = p_date
    AND sli.arrival_time::time >= p_start_time
    AND sli.arrival_time::time <= p_end_time
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    WHERE si.service_id = p_service_id
    AND DATE(sli.arrival_time) = p_date
    AND sli.arrival_time::time = p_time
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_all_service_instances() RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.service_instance;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_date_range(p_start_time TIMESTAMP, p_end_time TIMESTAMP) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE sli.departure_time >= p_start_time
    AND sli.departure_time <= p_end_time
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_date(p_date DATE) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE DATE(sli.departure_time) = p_date
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_departure_time_range(p_start_time TIMESTAMP, p_end_time TIMESTAMP) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_arrival_time_range(p_start_time TIMESTAMP, p_end_time TIMESTAMP) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE sli.arrival_time >= p_start_time
    AND sli.arrival_time <= p_end_time
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_instances_by_departure_date_range(p_start_date DATE, p_end_date DATE) RETURNS SETOF network.service_instance AS $$
BEGIN
    RETURN QUERY SELECT si.*
    FROM network.service_instance si
    JOIN network.service_link_instance sli ON si.id = sli.service_instance_id
    WHERE DATE(sli.departure_time) >= p_start_date
    AND DATE(sli.departure_time) <= p_end_date
    GROUP BY si.id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_scheduled_stop_by_id(p_id BIGINT) RETURNS network.scheduled_stop AS $$
DECLARE    v_scheduled_stop network.scheduled_stop%ROWTYPE;
BEGIN
    SELECT * INTO v_scheduled_stop
    FROM network.scheduled_stop    WHERE id = p_id;
    RETURN v_scheduled_stop;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_scheduled_stops_by_service_instance_id(p_service_instance_id BIGINT) RETURNS SETOF network.scheduled_stop AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.scheduled_stop WHERE service_instance_id = p_service_instance_id ORDER BY sequence_order;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.insert_scheduled_stop(p_stop_id BIGINT, p_stop_point_id BIGINT, p_service_instance_id BIGINT, p_sequence_order INTEGER, p_scheduled_time TIMESTAMP, p_actual_time TIMESTAMP, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE    v_id BIGINT;
BEGIN
    INSERT INTO network.scheduled_stop(stop_id, stop_point_id, service_instance_id, sequence_order, scheduled_time, actual_time, created_at, updated_at, updated_by)
    VALUES (p_stop_id, p_stop_point_id, p_service_instance_id, p_sequence_order, p_scheduled_time, p_actual_time, now(), now(), p_updated_by)
    RETURNING id INTO v_id;
    RETURN v_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.update_scheduled_stop(p_id BIGINT, p_stop_id BIGINT, p_stop_point_id BIGINT, p_service_instance_id BIGINT, p_sequence_order INTEGER, p_scheduled_time TIMESTAMP, p_actual_time TIMESTAMP, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE network.scheduled_stop SET
    stop_id = p_stop_id,
    stop_point_id = p_stop_point_id,
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_scheduled_stop(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.scheduled_stop WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_scheduled_stops_by_service_instance_id(p_service_instance_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.scheduled_stop WHERE service_instance_id = p_service_instance_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_link_instance_by_id(p_id BIGINT) RETURNS network.service_link_instance AS $$
DECLARE    v_service_link_instance network.service_link_instance%ROWTYPE;
BEGIN
    SELECT * INTO v_service_link_instance
    FROM network.service_link_instance    WHERE id = p_id;
    RETURN v_service_link_instance;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_link_instances_by_service_instance_id(p_service_instance_id BIGINT) RETURNS SETOF network.service_link_instance AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.service_link_instance WHERE service_instance_id = p_service_instance_id ORDER BY departure_time;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_link_instances_by_service_link_id(p_service_link_id BIGINT) RETURNS SETOF network.service_link_instance AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.service_link_instance WHERE service_link_id = p_service_link_id ORDER BY departure_time;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_link_instances_by_service_id(p_service_id BIGINT) RETURNS SETOF network.service_link_instance AS $$
BEGIN
    RETURN QUERY SELECT sli.*
    FROM network.service_link_instance sli
    JOIN network.service_instance si ON sli.service_instance_id = si.id
    WHERE si.service_id = p_service_id
    ORDER BY sli.departure_time;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_link_instances_by_line_id(p_line_id BIGINT) RETURNS SETOF network.service_link_instance AS $$
BEGIN
    RETURN QUERY SELECT sli.*
    FROM network.service_link_instance sli
    JOIN network.service_instance si ON sli.service_instance_id = si.id
    JOIN network.service s ON si.service_id = s.id
    WHERE s.line_id = p_line_id
    ORDER BY sli.departure_time;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_all_service_link_instances() RETURNS SETOF network.service_link_instance AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.service_link_instance;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_link_instances_by_departure_time_range(p_start_time TIMESTAMP, p_end_time TIMESTAMP) RETURNS SETOF network.service_link_instance AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.service_link_instance
    WHERE departure_time >= p_start_time
    AND departure_time <= p_end_time
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_link_instances_by_arrival_time_range(p_start_time TIMESTAMP, p_end_time TIMESTAMP) RETURNS SETOF network.service_link_instance AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.service_link_instance    WHERE arrival_time >= p_start_time
    AND arrival_time <= p_end_time
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_link_instances_by_departure_date_range(p_start_date DATE, p_end_date DATE) RETURNS SETOF network.service_link_instance AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.service_link_instance
    WHERE DATE(departure_time) >= p_start_date
    AND DATE(departure_time) <= p_end_date
    ORDER BY departure_time;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.get_service_link_instances_by_arrival_date_range(p_start_date DATE, p_end_date DATE) RETURNS SETOF network.service_link_instance AS $$
BEGIN
    RETURN QUERY SELECT * FROM network.service_link_instance
    WHERE DATE(arrival_time) >= p_start_date
    AND DATE(arrival_time) <= p_end_date
    ORDER BY arrival_time;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.insert_service_link_instance(p_service_instance_id BIGINT, p_service_link_id BIGINT, p_departure_time TIMESTAMP, p_arrival_time TIMESTAMP, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
DECLARE    v_id BIGINT;
BEGIN
    INSERT INTO network.service_link_instance(service_instance_id, service_link_id, departure_time, arrival_time, created_at, updated_at, updated_by)
    VALUES (p_service_instance_id, p_service_link_id, p_departure_time, p_arrival_time, now(), now(), p_updated_by)
    RETURNING id INTO v_id;
    RETURN v_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.update_service_link_instance(p_id BIGINT, p_service_instance_id BIGINT, p_service_link_id BIGINT, p_departure_time TIMESTAMP, p_arrival_time TIMESTAMP, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE network.service_link_instance SET
    service_instance_id = p_service_instance_id,
    service_link_id = p_service_link_id,
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_service_link_instance(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.service_link_instance WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_service_link_instances_by_service_instance_id(p_service_instance_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.service_link_instance WHERE service_instance_id = p_service_instance_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_service_link_instances_by_service_link_id(p_service_link_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.service_link_instance WHERE service_link_id = p_service_link_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_service_link_instances_by_service_id(p_service_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.service_link_instance sli
    USING network.service_instance si
    WHERE sli.service_instance_id = si.id
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_service_link_instances_by_line_id(p_line_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.service_link_instance sli
    USING network.service_instance si
    JOIN network.service s ON si.service_id = s.id
...
-- =========================================================
CREATE OR REPLACE FUNCTION network.insert_service_calendar(
    p_start_date DATE,
    p_end_date DATE,
    p_monday BOOLEAN,
    p_tuesday BOOLEAN,
...
DECLARE
    v_id BIGINT;
BEGIN
    INSERT INTO network.service_calendar(
        start_date, end_date, monday, tuesday, wednesday, thursday, friday, saturday, sunday,
        created_at, updated_at, updated_by
    ) VALUES (
        p_start_date, p_end_date, p_monday, p_tuesday, p_wednesday, p_thursday, p_friday, p_saturday, p_sunday,
        now(), now(), p_updated_by
    ) RETURNING id INTO v_id;
    RETURN v_id;
END;
...
-- =========================================================
CREATE OR REPLACE FUNCTION network.update_service_calendar(
    p_id BIGINT,
    p_start_date DATE,
    p_end_date DATE,
    p_monday BOOLEAN,
...
BEGIN
    UPDATE network.service_calendar SET
...
-- =========================================================
CREATE OR REPLACE FUNCTION network.delete_service_calendar(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM network.service_calendar WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.get_vehicle_by_id(p_id BIGINT) RETURNS operation.vehicle AS $$
BEGIN
    RETURN (SELECT * FROM operation.vehicle WHERE id = p_id);
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.get_vehicles_by_operator_id(p_operator_id BIGINT) RETURNS SETOF operation.vehicle AS $$
BEGIN
    RETURN QUERY SELECT * FROM operation.vehicle WHERE operator_id = p_operator_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.get_vehicles_by_capacity(p_capacity INT) RETURNS SETOF operation.vehicle AS $$
BEGIN
    RETURN QUERY SELECT * FROM operation.vehicle WHERE capacity = p_capacity;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.get_vehicles_by_vehicle_type(p_vehicle_type VARCHAR) RETURNS SETOF operation.vehicle AS $$
BEGIN
    RETURN QUERY SELECT * FROM operation.vehicle WHERE vehicle_type = p_vehicle_type;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.insert_vehicle(p_code VARCHAR, p_registration VARCHAR, p_vehicle_type VARCHAR, p_capacity INT, p_seat_layout BIGINT, p_fuel common.FUEL_TYPE, p_operator_id BIGINT, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
BEGIN
    INSERT INTO operation.vehicle (code, registration, vehicle_type, capacity, seat_layout, fuel, operator_id, updated_by)
    VALUES (p_code, p_registration, p_vehicle_type, p_capacity, p_seat_layout, p_fuel, p_operator_id, p_updated_by)
    RETURNING id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.update_vehicle(p_id BIGINT, p_code VARCHAR, p_registration VARCHAR, p_vehicle_type VARCHAR, p_capacity INT, p_seat_layout BIGINT, p_fuel common.FUEL_TYPE, p_operator_id BIGINT, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE operation.vehicle SET
    code = p_code,
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.delete_vehicle(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM operation.vehicle WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.insert_vehicle_service_assignment(p_vehicle_id BIGINT, p_service_instance_id BIGINT, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS BIGINT AS $$
BEGIN
    INSERT INTO operation.vehicle_service_assignment (vehicle_id, service_instance_id, updated_by)
    VALUES (p_vehicle_id, p_service_instance_id, p_updated_by)
    RETURNING id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.update_service_journey_status(p_service_journey_id BIGINT, p_status common.JOURNEY_STATUS, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    INSERT INTO operation.service_journey_status (service_journey_id, status, created_at, updated_at, updated_by)
    VALUES (p_service_journey_id, p_status, now(), now(), p_updated_by)
    ON CONFLICT (service_journey_id) DO UPDATE SET
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.get_service_journey_status(p_service_journey_id BIGINT) RETURNS common.JOURNEY_STATUS AS $$
DECLARE
    v_status common.JOURNEY_STATUS;
BEGIN
    SELECT status INTO v_status
    FROM operation.service_journey_status
    WHERE service_journey_id = p_service_journey_id;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.get_vehicles_assigned_to_service_instance(p_service_instance_id BIGINT) RETURNS SETOF operation.vehicle AS $$
BEGIN
    RETURN QUERY
    SELECT v.*
    FROM operation.vehicle v
    JOIN operation.vehicle_service_assignment vsa ON v.id = vsa.vehicle_id
    WHERE vsa.service_instance_id = p_service_instance_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.delete_service_journey_status(p_service_journey_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM operation.service_journey_status WHERE service_journey_id = p_service_journey_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION operation.delete_vehicle_service_assignment(p_id BIGINT) RETURNS VOID AS $$
BEGIN
    DELETE FROM operation.vehicle_service_assignment WHERE id = p_id;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
Create OR REPLACE FUNCTION tracking.insert_vehicle_position(p_vehicle_id BIGINT, p_recorded_at TIMESTAMP, p_geo common.geography, p_speed REAL, p_bearing REAL, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    INSERT INTO tracking.vehicle_position (vehicle_id, recorded_at, geo, speed, bearing, created_at, updated_at, updated_by)
    VALUES (p_vehicle_id, p_recorded_at, p_geo, p_speed, p_bearing, now(), now(), p_updated_by);
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION tracking.get_vehicle_positions_by_vehicle_id(p_vehicle_id BIGINT) RETURNS SETOF tracking.vehicle_position AS $$
BEGIN
    RETURN QUERY SELECT * FROM tracking.vehicle_position WHERE vehicle_id = p_vehicle_id ORDER BY recorded_at DESC;
END;
$$ LANGUAGE plpgsql;
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION tracking.update_vehicle_position(p_vehicle_id BIGINT, p_geo common.geography, p_speed REAL, p_bearing REAL, p_updated_by VARCHAR DEFAULT CURRENT_USER) RETURNS VOID AS $$
BEGIN
    UPDATE tracking.vehicle_position SET
    recorded_at = now(),
    geo = p_geo,
    speed = p_speed,
    bearing = p_bearing,
...
-- 
-- =========================================================
CREATE OR REPLACE FUNCTION tracking.delete_vehicle_position(p_vehicle_id BIGINT) RETURNS VOID AS $$    
BEGIN
    DELETE FROM tracking.vehicle_position WHERE vehicle_id = p_vehicle_id;
END;
$$ LANGUAGE plpgsql;
